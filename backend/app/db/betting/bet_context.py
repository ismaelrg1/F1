...
if TYPE_CHECKING:
    from app.db.betting import Bet, BetException, BetEditPermission, BetResultsVisibilityPolicy
...
class BetContext(Base):
    ...
    results_visibility_policies: Mapped[list["BetResultsVisibilityPolicy"]] = relationship(
